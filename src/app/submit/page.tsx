...
const PRESETS = [
  {
    ...
    name: "Sarah Lin",
    contact: "sarah.lin@example.com | (555) 234-5678",
  },
  {
    label: "Fossil Wallet (Lost)",
    type: "lost" as ReportType,
    title: "Fossil Brown Leather Bi-fold Wallet",
    category: "Wallets & Cards",
    description: "Lost my vintage Fossil brown leather bi-fold wallet on the metro line 4 train. Has California driver's license and red stitching inside.",
    location: "Downtown Metro Station / Line 4 Train",
    image: "https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=800&q=80",
    name: "David Kim",
    contact: "dkim99@example.com",
  },
  {
    label: "Found Keys (Found)",
    type: "found" as ReportType,
    title: "Toyota Car Key & House Keys with Stitch Plush",
    category: "Keys",
    description: "Found a set of keys on Oak Avenue sidewalk. Has a Toyota car fob, 3 silver keys, and a cute blue Stitch keychain.",
    location: "Oak Avenue sidewalk near 5th St",
